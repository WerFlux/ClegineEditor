    ...
    , formatter_(details::make_unique<spdlog::pattern_formatter>())
{
    ...
    // set level colors
    colors_[level::trace] = FOREGROUND_GREEN | FOREGROUND_BLUE;                         // cyan (original white)
    colors_[level::debug] = FOREGROUND_GREEN;                                           // green (original cyan)
    colors_[level::info] = FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE;         // white (original green)
